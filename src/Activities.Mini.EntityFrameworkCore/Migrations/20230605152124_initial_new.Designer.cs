...
namespace Activities.Mini.Migrations
{
    ...
    [Migration("20230605152124_initial_new")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Activities.Mini.WxActivities.Activity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("WxActivity", (string)null);
                });

            modelBuilder.Entity("Activities.Mini.WxActivities.ActivityAppendix", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("WxActivityAppendix", (string)null);
                });

            modelBuilder.Entity("Activities.Mini.WxActivities.ActivityUser", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("AttendTime");

                    b.HasIndex("WxUserId");

                    b.ToTable("WxActivityUser", (string)null);
                });

            modelBuilder.Entity("Activities.Mini.WxActivities.WxUser", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<int>("IsChinese")
                        .HasColumnType("int")
                        .HasColumnName("IsChinese");

                    b.Property<string>("MiniOpenId")
                        .HasMaxLength(200)
                        .HasColumnType("varchar(200)")
                        .HasColumnName("MiniOpenId");
            ...
            modelBuilder.Entity("Activities.Mini.WxActivities.ActivityAppendix", b =>
                {
                    b.HasOne("Activities.Mini.WxActivities.Activity", null)
                        .WithMany("ActivityAppendices")
            ...
            modelBuilder.Entity("Activities.Mini.WxActivities.ActivityUser", b =>
                {
                    ...
                    b.HasOne("Activities.Mini.WxActivities.WxUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Activities.Mini.WxActivities.Activity", b =>
                {
                    b.Navigation("ActivityAppendices");
